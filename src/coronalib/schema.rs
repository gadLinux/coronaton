...
pub fn create_schema() -> Schema {
    ...
    let schema = Schema::new(vec![
        ...
        Field::new("mother_married", DataType::UInt8, false),
        Field::new("mother_birth_state", DataType::Utf8, false),
        Field::new("cigarette_use", DataType::UInt8, false),
        Field::new("cigarette_per_day", DataType::UInt8, false),
        Field::new("alcohol_use", DataType::UInt8, false),
